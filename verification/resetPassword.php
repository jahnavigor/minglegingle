...
<!DOCTYPE html>
<?php 
$mysqli = new mysqli("localhost","root","","db_dating_app");
...
if(!isset($error)){
  ...
  <div class="form-group">
    <img src="../utilities/icon.png" alt="chipstrip" style = "padding-top: 25px;padding-bottom: 25px;border-radius:50px;" class="logo img-fluid"> 
    <br>
   <?php 
if(isset($error)){
